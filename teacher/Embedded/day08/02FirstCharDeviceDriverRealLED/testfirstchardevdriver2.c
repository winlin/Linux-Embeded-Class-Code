...
int main(int argc, char **argv)
{
	...
	if( 0 > fd ) {
		printf("Failure to open device file: /dev/firstchardevdriver2 !\n");
		exit( -1 );
	}
	printf("Success to open device file: /dev/firstchardevdriver2 !\n");

	while( 1 ) {
		printf("Starting to control LED2 on Real6410...\n");
	...
	close( fd );
	printf("Success to test device: /dev/firstchardevdriver2 ! \n");
