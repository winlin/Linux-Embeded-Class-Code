...
int main(int argc, char **argv)
{
	...
	if( 0 > fd ) {
		printf("Failure to open device file: /dev/firstchardevdriver1 !\n");
		exit( -1 );
	}
	printf("Success to open device file: /dev/firstchardevdriver1 !\n");

	while( 1 ) {
		printf("Starting to control LED1 on Real6410...\n");
	...
	close( fd );
	printf("Success to test device: /dev/firstchardevdriver1 ! \n");
