...
void leddm_update_data(void)
{
    ...
    for(i=0;i<LED_DM_WIDTH;++i)
	    *(leddm_cdevp->pdata_data+(LED_DM_HEIGHT-1)*LED_DM_WIDTH + i)=(*(leddm_cdevp->pdata_data+ (LED_DM_HEIGHT-1)*LED_DM_WIDTH+i))?0:1;
    for(i=0;i<LED_DM_WIDTH;++i)
	    *(leddm_cdevp->pdata_data+ i)=(*(leddm_cdevp->pdata_data+ i))?0:1;
